def main():
    ...
    basepath="D:/Rushikesh khatke/Rushikesh25-26/25c9404 -FAKE adhar card detection CNN/100% code/new 100% code"
    ...
    #Adding 5rd Concolution Layer
    classifier.add(Convolution2D(64, 1,  1, activation = 'relu'))
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    
    #Adding 6rd Concolution Layer
    classifier.add(Convolution2D(64, 1,  1, activation = 'relu'))
    classifier.add(MaxPooling2D(pool_size =(2,2)))
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/fakeaadhar_model.h5')
